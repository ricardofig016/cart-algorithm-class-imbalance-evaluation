...
\begin{frame}{Data Characteristic}
    ...
    maximize node purity, leading them to favor the majority class at 
    the expense of the minority class. This is due to the 
    ...
    \begin{itemize}
        ...
        \item Suitable prediction metrics (e.g. precision, recall,
        f1-score)
    \end{itemize}
\end{frame}
...
\begin{figure}
    \includegraphics[width=.6\textwidth]{results/comparisons/improvement_summary.png}
\end{figure}
\end{frame}
